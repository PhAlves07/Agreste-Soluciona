    ...
    <div className="min-h-screen bg-gray-200">
      ...
      <div className="max-w-2xl mx-auto bg-gray-100 mt-10 rounded-xl shadow-md p-8">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-semibold mt-3">Configurações</h1>
        </div>
        ...
        <div className="space-y-7">
          ...
          <button
            ...
            className="w-full flex items-center gap-4 p-4 bg-white rounded-xl shadow hover:bg-gray-50 transition"
          >
            <Bell
              size={32}
